...
function renderBodyDiagram(){
    ...
    const exercises = {
        ...
        traps: [
            {name: "Barbell Shrugs", img: "images/quads/Barbell Back Squat.jpg", url: "https://www.youtube.com/shorts/TUBuBI1U1wc"},
            {name: "Behind-the-Back Barbell Shrugs", img: "images/quads/Front Squat.jpg", url: "https://www.youtube.com/shorts/xKS-kFgXNPU"},
            {name: "Upright Rows", img: "images/quads/Hack Squat.jpg", url: "https://www.youtube.com/shorts/AWsGWt-VMl8"},
            {name: "Snatch-Grip Deadlift", img: "images/quads/Zercher Squat.jpg", url: "https://www.youtube.com/watch?v=E42_MZOKktU"},
            {name: "Rack Pulls", img: "images/quads/Box Squat.jpg", url: "https://www.youtube.com/shorts/qFqbJqboCHU"},
            {name: "Dumbbell Shrugs", img: "images/quads/Dumbbell Goblet Squat.jpg", url: "https://www.youtube.com/shorts/rFsSeClGnNA"},
            {name: "Incline Dumbbell Shrugs", img: "images/quads/Dumbbell Split Squat.jpg", url: "https://www.youtube.com/shorts/xEkIB8PeNv0"},
            {name: "Farmer’s Walk", img: "images/quads/Bulgarian Split Squat.jpg", url: "https://www.youtube.com/shorts/HDoNIkik8r8"},
            {name: "Dumbbell Upright Rows", img: "images/quads/Dumbbell Step-Ups.jpg", url: "https://www.youtube.com/shorts/fbc8FrvjFHk"},
            {name: "Dumbbell High Pulls", img: "images/quads/Dumbbell Front Squat.jpg", url: "https://www.youtube.com/watch?v=o0KJD3Xn3fc"},
            {name: "Cable Shrugs", img: "images/quads/Leg Press.jpg", url: "https://www.youtube.com/shorts/m2ifHLnEIaA"},
            {name: "Cable Face Pulls", img: "images/quads/Leg Extensions.jpg", url: "https://www.youtube.com/shorts/qEyoBOpvqR4"},
            {name: "Reverse Cable Flyes", img: "images/quads/Cable Pull Through.jpg", url: "https://www.youtube.com/shorts/xswhV6zJaxY"},
            {name: "Smith Machine Shrugs", img: "images/quads/Sissy Squat.jpg", url: "https://www.youtube.com/shorts/zdBh_Ul2psI"},
            {name: "Seated Cable Rows", img: "images/quads/Smith Machine Front Squat.jpg", url: "https://www.youtube.com/shorts/qD1WZ5pSuvk"},
        ],
        delts: [
            {name: "Overhead Barbell Press", img: "images/quads/Barbell Back Squat.jpg", url: "https://www.youtube.com/shorts/4LBVP2Oe7fg"},
            {name: "Behind-the-Neck Press", img: "images/quads/Front Squat.jpg", url: "https://www.youtube.com/shorts/2EZLxxKRHYY"},
            {name: "Upright Rows", img: "images/quads/Hack Squat.jpg", url: "https://www.youtube.com/watch?v=um3VVzqunPU"},
            {name: "Front Barbell Raise", img: "images/quads/Zercher Squat.jpg", url: "https://www.youtube.com/shorts/MNho_Zw3mFc"},
            {name: "Arnold Press", img: "images/quads/Box Squat.jpg", url: "https://www.youtube.com/shorts/g4GUrEFoBxY"},
            {name: "Seated Dumbbell Shoulder Press", img: "images/quads/Dumbbell Goblet Squat.jpg", url: "https://www.youtube.com/shorts/k6tzKisR3NY"},
            {name: "Lateral Dumbbell Raises", img: "images/quads/Dumbbell Split Squat.jpg", url: "https://www.youtube.com/shorts/iK22GwXJji0"},
            {name: "Front Dumbbell Raises", img: "images/quads/Bulgarian Split Squat.jpg", url: "https://www.youtube.com/shorts/h9xfpTrAvkE"},
            {name: "Rear Delt Flyes", img: "images/quads/Dumbbell Step-Ups.jpg", url: "https://www.youtube.com/shorts/LsT-bR_zxLo"},
            {name: "Incline Bench Rear Delt Raises", img: "images/quads/Dumbbell Front Squat.jpg", url: "https://www.youtube.com/shorts/lRTT2YABNIM"},
            {name: "Dumbbell High Pulls", img: "images/quads/Leg Press.jpg", url: "https://www.youtube.com/watch?v=o0KJD3Xn3fc"},
            {name: "Single-Arm Dumbbell Press", img: "images/quads/Leg Extensions.jpg", url: "https://www.youtube.com/shorts/Cs2uNF-jW5s"},
            {name: "Cable Lateral Raises", img: "images/quads/Cable Pull Through.jpg", url: "https://www.youtube.com/shorts/xrBcuPNTxLg"},
            {name: "Cable Front Raises", img: "images/quads/Sissy Squat.jpg", url: "https://www.youtube.com/shorts/NdQE5Fhfqn4"},
            {name: "Reverse Cable Flyes", img: "images/quads/Smith Machine Front Squat.jpg", url: "https://www.youtube.com/shorts/xswhV6zJaxY"},
        ],        
        lats: [
            {name: "Barbell Bent-Over Rows", img: "images/quads/Barbell Back Squat.jpg", url: "https://www.youtube.com/shorts/phVtqawIgbk"},
            {name: "Pendlay Rows", img: "images/quads/Front Squat.jpg", url: "https://www.youtube.com/watch?v=EzFkN5ge5_k"},
            {name: "Underhand Barbell Rows", img: "images/quads/Hack Squat.jpg", url: "https://www.youtube.com/shorts/ElNQUyDoxkM"},
            {name: "T-Bar Rows", img: "images/quads/Zercher Squat.jpg", url: "https://www.youtube.com/shorts/MIulz5576AY"},
            {name: "Deadlifts", img: "images/quads/Box Squat.jpg", url: "https://www.youtube.com/shorts/xNwpvDuZJ3k"},
            {name: "One-Arm Dumbbell Row", img: "images/quads/Dumbbell Goblet Squat.jpg", url: "https://www.youtube.com/shorts/s1H87k4tAaA"},
            {name: "Dumbbell Pullover", img: "images/quads/Dumbbell Split Squat.jpg", url: "https://www.youtube.com/shorts/iy0VwFjTWds"},
            {name: "Incline Dumbbell Rows", img: "images/quads/Bulgarian Split Squat.jpg", url: "https://www.youtube.com/watch?v=tZUYS7X50so"},
            {name: "Kroc Rows", img: "images/quads/Dumbbell Step-Ups.jpg", url: "https://www.youtube.com/shorts/FY53-vxHU34"},
            {name: "Chest-Supported Dumbbell Rows", img: "images/quads/Dumbbell Front Squat.jpg", url: "https://www.youtube.com/shorts/woHK8Lws2xM"},
            {name: "Lat Pulldowns", img: "images/quads/Leg Press.jpg", url: "https://www.youtube.com/shorts/51ql2-2kLfA"},
            {name: "Close-Grip Lat Pulldowns", img: "images/quads/Leg Extensions.jpg", url: "https://www.youtube.com/shorts/E8cpBEoCrOs"},
            {name: "Straight-Arm Cable Pulldowns", img: "images/quads/Cable Pull Through.jpg", url: "https://www.youtube.com/shorts/RK2PRy9VwPg"},
            {name: "Seated Cable Rows", img: "images/quads/Sissy Squat.jpg", url: "https://www.youtube.com/shorts/qD1WZ5pSuvk"},
            {name: "Single-Arm Cable Rows", img: "images/quads/Smith Machine Front Squat.jpg", url: "https://www.youtube.com/shorts/yIvvQc2Z6uM"},
        ],
        glutes: [
            {name: "Barbell Hip Thrusts", img: "images/quads/Barbell Back Squat.jpg", url: "https://www.youtube.com/watch?v=pUdIL5x0fWg"},
            {name: "Barbell Glute Bridges", img: "images/quads/Front Squat.jpg", url: "https://www.youtube.com/shorts/DrZdxtfEgik"},
            {name: "Sumo Deadlifts", img: "images/quads/Hack Squat.jpg", url: "https://www.youtube.com/watch?v=pfSMst14EFk"},
            {name: "Romanian Deadlifts", img: "images/quads/Zercher Squat.jpg", url: "https://www.youtube.com/shorts/g5u75sgpn04"},
            {name: "Good Mornings", img: "images/quads/Box Squat.jpg", url: "https://www.youtube.com/shorts/7cpldMZjLOs"},
            {name: "Dumbbell Step-Ups", img: "images/quads/Dumbbell Goblet Squat.jpg", url: "https://www.youtube.com/shorts/8q9LVgN2RD4"},
            {name: "Dumbbell Walking Lunges", img: "images/quads/Dumbbell Split Squat.jpg", url: "https://www.youtube.com/shorts/mJilHWIBWO8"},
            {name: "Goblet Squats", img: "images/quads/Bulgarian Split Squat.jpg", url: "https://www.youtube.com/shorts/lRYBbchqxtI"},
            {name: "Dumbbell Romanian Deadlifts", img: "images/quads/Dumbbell Step-Ups.jpg", url: "https://www.youtube.com/shorts/oQwnGfZFfzw"},
            {name: "Kettlebell Swings", img: "images/quads/Dumbbell Front Squat.jpg", url: "https://www.youtube.com/shorts/n1df4ASFeZU"},
            {name: "Cable Kickbacks", img: "images/quads/Leg Press.jpg", url: "https://www.youtube.com/watch?v=SqO-VUEak2M"},
            {name: "Cable Pull-Throughs", img: "images/quads/Leg Extensions.jpg", url: "https://www.youtube.com/embed/iQ92TuvBqRo"},
            {name: "Smith Machine Hip Thrusts", img: "images/quads/Cable Pull Through.jpg", url: "https://www.youtube.com/shorts/i5Vpsf-c6r0"},
            {name: "Leg Press", img: "images/quads/Sissy Squat.jpg", url: "https://www.youtube.com/shorts/EotSw18oR9w"},
            {name: "Abductor Machine", img: "images/quads/Smith Machine Front Squat.jpg", url: "https://www.youtube.com/shorts/vNixlpsswr8"},
        ],
