...
function renderBodyDiagram(){
    ...
    const exercises = {
        chest: [
            ...
            {name: "Close-Grip Bench Press", img: "images/chest/Dumbbell-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/4yKLxOsrGfg"},
            {name: "Wide-Grip Bench Press", img: "images/chest/Dumbbell-Chest-Press.jpg", url: "https://www.youtube.com/shorts/NQNWLYJTtHA"},
            {name: "Incline Bench Press", img: "images/chest/Dumbbell-Incline-Chest-Press.jpg", url: "https://www.youtube.com/shorts/8fXfwG4ftaQ"},
            {name: "Decline Barbell Press", img: "images/chest/High-to-Low-Cable-Crossover.jpg", url: "https://www.youtube.com/shorts/a-UFQE4oxWY"},
            {name: "Incline Dumbbell Bench Press", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/Gruq177Psnk"},
            {name: "Decline Dumbbell Bench Press", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/5JiZFjxyoJQ"},
            {name: "Dumbbell Chest Press", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/WbCEvFA0NJs"},
            {name: "Dumbbell Chest Flyes", img: "images/chest/Machine-Chest-Press.jpg", url: "https://www.youtube.com/shorts/rk8YayRoTRQ"},
            {name: "Machine Fly", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/xYExAgLt_4I"},
            {name: "Machine Chest Press", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/Qu7-ceCvq7w"},
            {name: "Dumbbell Pullover", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/Datv2L6t3-4"},
            {name: "Cable Flyes", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/y4RJDSOBEl8"},
            {name: "Incline Cable Flyes", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/-Eq_GScOGOE"},
            {name: "Cable Crossover", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/WIErn7-YvYQ"},
        ],
        biceps: [
            {name: "Standing Dumbbell Curls", img: "images/chest/Bench-Press.jpg", url: "https://www.youtube.com/shorts/oLyP6sORFOc"},
            {name: "Alternating Dumbbell Curls", img: "images/chest/Dumbbell-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/FHY_2t7R714"},
            {name: "Hammer Curls", img: "images/chest/Dumbbell-Chest-Press.jpg", url: "https://www.youtube.com/shorts/vm0zV_WQerE"},
            {name: "Concentration Curls", img: "images/chest/Dumbbell-Incline-Chest-Press.jpg", url: "https://www.youtube.com/shorts/EjUnEEfTSEY"},
            {name: "Incline Dumbbell Curls", img: "images/chest/High-to-Low-Cable-Crossover.jpg", url: "https://www.youtube.com/shorts/fXFN8_1Bh6k"},
            {name: "Zottman Curls", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/5Go_uOTnFl0"},
            {name: "Cross-Body Hammer Curls", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/qmQkt1Y-FX8"},
            {name: "Seated Alternating Dumbbell Curls", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/16v_0ET03Oo"},
            {name: "Barbell Curls", img: "images/chest/Machine-Chest-Press.jpg", url: "https://www.youtube.com/shorts/54x2WF1_Suc"},
            {name: "EZ Bar Curls", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/KFinlAT6aEo"},
            {name: "Reverse Curls", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/ZG2n5IcYIcY"},
            {name: "Wide-Grip Barbell Curls", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/pgeSaAKOXRs"},
            {name: "Close-Grip Barbell Curls", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/a6ZJAmhCfjU"},
            {name: "Cable Bicep Curls", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/CrbTqNOlFgE"},
            {name: "Overhead Cable Curls", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/grFE5bhFmiQ"},
        ],
        abs: [
            {name: "Weighted Crunches", img: "images/chest/Bench-Press.jpg", url: "https://www.youtube.com/shorts/Yg6GsyZoqK0"},
            {name: "Russian Twists", img: "images/chest/Dumbbell-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/aRUMRbl7KS4"},
            {name: "Dumbbell Side Bend", img: "images/chest/Dumbbell-Chest-Press.jpg", url: "https://www.youtube.com/shorts/kqr_IjiUuyY"},
            {name: "Weighted Sit-Ups", img: "images/chest/Dumbbell-Incline-Chest-Press.jpg", url: "https://www.youtube.com/shorts/MXOK5F6SKXQ"},
            {name: "Crunches", img: "images/chest/High-to-Low-Cable-Crossover.jpg", url: "https://www.youtube.com/shorts/eeJ_CYqSoT4"},
            {name: "Reverse Crunches", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/JkTk8irSNKE"},
            {name: "Bicycle Crunches", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/CakPX7X-mSw"},
            {name: "Leg Raises", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/FijNSgahpz0"},
            {name: "Flutter Kicks", img: "images/chest/Machine-Chest-Press.jpg", url: "https://www.youtube.com/shorts/tPmybsDX8ZY"},
            {name: "Toe Touches", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/20P7MU4Oaec"},
            {name: "Mountain Climbers", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/dqjZ6BGhY9s"},
            {name: "V-Ups", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/Wks3wpNJqTg"},
            {name: "Plank", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/xe2MXatLTUw"},
            {name: "Side Plank", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/BFOyHDlY2UE"},
            {name: "Plank with Shoulder Tap", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/gccQ1hMX46U"},
        ],
        quads: [
            {name: "Barbell Back Squat", img: "images/chest/Bench-Press.jpg", url: "https://www.youtube.com/shorts/S9iWwaqbD3Q"},
            {name: "Front Squat", img: "images/chest/Dumbbell-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/_qv0m3tPd3s"},
            {name: "Hack Squat", img: "images/chest/Dumbbell-Chest-Press.jpg", url: "https://www.youtube.com/shorts/g9i05umL5vc"},
            {name: "Zercher Squat", img: "images/chest/Dumbbell-Incline-Chest-Press.jpg", url: "https://www.youtube.com/shorts/xtMpMCCzPrU"},
            {name: "Box Squat", img: "images/chest/High-to-Low-Cable-Crossover.jpg", url: "https://www.youtube.com/shorts/Go4tSkrFIL8"},
            {name: "Dumbbell Goblet Squat", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/lRYBbchqxtI"},
            {name: "Dumbbell Split Squat", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/sw4MzpC8l58"},
            {name: "Bulgarian Split Squat", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/or1frhkjBDc"},
            {name: "Dumbbell Step-Ups", img: "images/chest/Machine-Chest-Press.jpg", url: "https://www.youtube.com/shorts/8q9LVgN2RD4"},
            {name: "Dumbbell Front Squat", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/0hw86JiWjCM"},
            {name: "Leg Press", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/EotSw18oR9w"},
            {name: "Leg Extensions", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/iQ92TuvBqRo"},
            {name: "Cable Pull Through", img: "images/chest/Incline-Bench-Press.jpg", url: "https://www.youtube.com/shorts/SuTI-n84ezA"},
            {name: "Sissy Squat", img: "images/chest/Incline-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/f4ubaNbsq0Y"},
            {name: "Smith Machine Front Squat", img: "images/chest/Machine-Chest-Flies.jpg", url: "https://www.youtube.com/shorts/NO-6L6Blneg"},
        ],
